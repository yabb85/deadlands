...
export const cards = List([
	Map({color: 'card', figure: 0, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 1, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 2, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 3, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 4, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 5, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 6, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 7, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 8, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 9, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 10, dice: '', flip: -1, selected: true, removed: false}),
	Map({color: 'card', figure: 11, dice: '', flip: -1, selected: true, removed: false})
])
...
export const assets = List([
	...
	Map({name: "Bigleux", definition: "Parfois, Il vaut mieux pas voir ce qui te tombe dessus. Etre bigleux affecte tous les tests d'Apptitude ou de Trait que tu fais pour distinguer quelques chose a plus de 20 mètres. Le marshall peut parfois t'autoriser a te servir de ce defaut comme un bonus à tes jets de tripes lorsque tu regardes de loin une scène horrible.", value: [3, 5], type: "handicap"}),
	Map({name: "Boiteux", definition: "Il y a un vieux dicton qui dit : quand quelques chose te poursuit, il te suffit de dépasser au moins une personne pour avoir la vie sauve. Malheureusement pour toi, tu es généralemnt la personne en question. Ce Handicap affecte les déplacements du personange et sa capacité à faire une defense active.", value: [3, 5], type: "handicap"}),
	Map({name: "Ça va les chevilles", definition: "C'est bien d'avoir confiance en soi, mais faut être cintré pour charger 5000 Sioux avec 600 cavaliers. Ton personnage est super sûr de lui. Il croit que rien ne lui resiste. et il ne refuse jamais un défi.", value: [3], type: "handicap"}),
	...
	Map({name: "Cupide", definition: "C'est l'un des sept péché capitaux. Mais ton âme peus bien etre damné, tu auras au moins pris du bon temps sur terre à rouler sur l'or. L'argent et le pouvoir signifie tout pour ta canaile de personnage, et il fera n'importe quoi pour en avoir toujours plus.", value: [], type: "handicap"}),
	...
	Map({name: "Dèche", definition: "Un pauvre connait le prix de tout et la valeur de rien. Un personnage misereux doit toujours acheter les trucs les moins chers et marchander sans cesse. Il peut seulement acheter le matos d'occase.", value: [3], type: "handicap"}),
	Map({name: "Deux mains gauche", definition: "T'aime pas les machines, et elle te le rendent bien. Les Aptitudes scientifiques et techniques coutent 2 fois plus de points de primes à acquerir et à develloper. Tous les jets pour reparer ou utiliser une machine se font a -2.", value: [2], type: "handicap"}),
	Map({name: "Douillet", definition: "Tu te chopes des échardes rien qu'en serrant la crosse de ton pistolet, et tu arretes seulement de te plaindre quand le chirurgien sort sa scie. Augmente les penalites de blessure de ton personnage de 1.", value: [3], type: "handicap"}),
	Map({name: "Ennemi", definition: "Rappelle-toi : chaque gars que tu as gentiment de dezingué a des amis ou de la famille qui peuvent le chercher ensuite. Ton personnage a un ou des ennemis. Avec le marshall, tu dois decider la valeur de chaque ennemi, en fonction de leur puissance et de la frequence de leur apparition. Un jeune revanchard inexperimenté qui poursuit le personnage. par exempe veut juste deux points, parce que même s'il intervient souvent, il n'est pas trés fort. Un déserteur peut se choisir un ennemi, mais ni l'union ni les conféderes n'ont de temps a perdre, donc cela nevaut que deux points.", value: [1,2,3,4,5], type: "handicap"}),
	Map({name: "Expatrier", definition: "Comment les gens peuvent ils t'aider s'ils ne te comprennent pas? Les expatriés sont étrangers à la culture dominante du lieu ou se déroule l'aventure ou le campagne. Generalement, les etrangers sont des Mexicains, des Indiens, des Chinois qui passnet des heures difficiles a s'adapter aux coutumes et au langage de l'homme blanc. Un Anglais qui s'obstine a deblaterer sur la democratie, ou un chinois employé du rail qui parle mal l'anglais ont deschances d'etre mis a l'ecart par la plupart des gens de la frontiere. Parfois, ce sont les Blancs lesexpatriés. Si ton Marshal dirige une campagne dans les teritoires Sioux. ceux qui ne connaissent pas les usages et les coutumes des indiens risquent de se retrouver dans une situation prejudiciable. Ausi longtemps que ton personnage peut communiquer correctement au seins de la culture dans laquelle il se trouve et qu'il abandonne pas ce comportement, histoire de se prouver qu'il est bien differnet, il ne devrait pas souffrir aucun prejudice, et tu n'as pas besoin de prendre ce handicap. Des personnages etrangers peuvent parfois souffrir du racisme de certains, mais la plupart du temps ils osnt bien traités dans le Weird West.", value: [3], type: "handicap"}),
	...
	Map({name: "Manchot", definition: "Des tas de véterans ont perdu leurs jambes et leurs bras durant la guerre. Croire que cela rend moins dangereux est une grossiere erreur. Aprés tout, on a besoind'un seul doigt pour actionner unegachette. Ton personnage n'a qu'une main ou qu'un bras. Il doit soustraire -4 a tout les jets de dés qui impliquent l'usage des deux mains.", value: [3], type: "handicap"}),
	...
	Map({name: "Pacifiste", definition: "Etre pacifiste signifie pas qu'un gars a peur d'une bagarre. En 1876, et bien qu'il ait été homme de loi pendant des années à Dodge et d'autres villes du meme genre, Wyatt Earp n'avait jamais tué un homme. Il etait bien connu pour assommer les cow-boys a coup de crosse, mais Earp était suffisament malin pour savoir que tuer un homme causait souvent, parmis une population et des amis revanchards, plus de problemes que cela n'en meritait. Le pacifiste peut etre celui qui n'aime pas tuer tant qu'il peut l'eviter (3 points) ou celui qui a decider de ne jamais tuer, quellesquesoient les circonstances (5 points).", value: [3,5], type: "handicap"}),
	Map({name: "Panier percé", definition: "Un idiot et son argant sont vite separés. Ton personnage a bien du mal à economiser de l'argent, et il dépense sans compter. Tout ce qu'il achete est vite mis au rancart et perdu ou abandonné. Il commence avec 50$ au lieu de 250$ et devrait plutot acheter du matos d'occase.", value: [3], type: "handicap"}),
	...
	Map({name: "Revanchard", definition: "Le monde a besoin d'une bonne leçon et c'est toi qui va la donner. Ton personnage doit toujours chercher a réparer les fautes que l'on a commises à son egard. Que cette reparation soit violente ou pas depend de sa nature.", value: [3], type: "handicap"}),
	...
	Map({name: "Têtu", definition: "C'est comme tu le sens ou pas du tout. Si le reste du monde est trop stupide pour se rendre compte que tu as raison, il peut aller se faire pendre. Ton heros est tetu comme une mule. Il veuttoujours faire les choses a sa maniere et insiste jusqu'a ce que tout le monde soit d'ccord ou ait fait des concessions.", value: [2], type: "handicap"}),
...
export const competencesDefinition = List([
	Map({
		...
		subsection: List([
			...
			Map({name: 'orientation', text: 'orientation', min: 0}),
