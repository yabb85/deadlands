...
export const competences = List([
	...
	Map({name: 'autre_per', text: 'autre', min: 0}),
	...
	Map({name: 'langues', text: 'langues', min: 0}),
	Map({name: 'natale', text: 'langue natal (2)', min: 2}),
	Map({name: 'medecine', text: 'medecine', min: 0}),
	Map({name: 'metier', text: 'metier', min: 0}),
	Map({name: 'science', text: 'science', min: 0}),
	Map({name: 'universalis', text: 'universalis', min: 0}),
	Map({name: 'autre_con', text: 'autre', min: 0}),
	Map({name: 'autorite', text: 'autorite', min: 0}),
	Map({name: 'dressage', text: 'dressage', min: 0}),
	Map({name: 'eloquence', text: 'eloquence', min: 0}),
	Map({name: 'intimider', text: 'intimider', min: 0}),
	Map({name: 'persuasion', text: 'persuasion', min: 0}),
	Map({name: 'spectacle', text: 'spectacle', min: 0}),
	Map({name: 'autre_cha', text: 'autre', min: 0}),
	...
	Map({name: 'autre_agi', text: 'autre', min: 0}),
	Map({name: 'autre_for', text: 'autre', min: 0}),
	Map({name: 'degainer', text: 'degainer', min: 0}),
	Map({name: 'autre_rap', text: 'autre', min: 0}),
	Map({name: 'autre_vig', text: 'autre', min: 0}),
])
